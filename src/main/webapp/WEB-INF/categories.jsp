                    ...
                    <div class="product__page__content">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <c:forEach items="${MoviesInCategory}" var="allMoviesInCategary">
                                <div class="product__item">
                                    <div class="product__item__pic set-bg" data-setbg="${allMoviesInCategary.coverImg}">
                                    ...
                                    <div class="product__item__text">
                                        ...
                                        <h5><a href="/details/${allMoviesInCategary.id}">${allMoviesInCategary.animeName}</a></h5>
                                    </div>
                                </div>
                                </c:forEach>
                            </div>
